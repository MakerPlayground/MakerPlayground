...
public abstract class Expression {
    ...
    public enum Type {
        SIMPLE_INTEGER, SIMPLE_STRING, ANIMATED_STRING, COMPLEX_STRING, PROJECT_VALUE, NUMBER_WITH_UNIT, NUMBER_IN_RANGE, CONDITIONAL, CUSTOM_NUMBER, DATETIME, VALUE_LINKING, IMAGE, VARIABLE, RECORD, STRING_INT, DOT_MATRIX;
    }
