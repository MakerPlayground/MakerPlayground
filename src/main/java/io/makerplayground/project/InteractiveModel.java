...
public class InteractiveModel {
    ...
    public void sendCommand(UserSetting userSetting) {
        if (userSetting.getDevice().equals(Memory.projectDevice) && userSetting.getAction().equals(Memory.setValue)) {
            ...
            expression.getProjectValue().ifPresent(projectValue -> valueMap.get(Memory.projectDevice).get(projectValue.getValue()).set(evaluateCustomNumberExpression((CustomNumberExpression) (userSetting.getParameterMap().get(Memory.valueParameter)))));
        }
        else {
