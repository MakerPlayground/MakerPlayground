...
public class ValueLinkingOnceControl extends GridPane {
    ...
    public ValueLinkingOnceControl(Expression expression, List<ProjectValue> projectValues, Parameter parameter) {
    ...
    private void initValueControl() {
        ...
        setHgap(10);
        setVgap(5);
        getChildren().addAll(fromLabel, valueCombobox, mappingEnableCheckbox);
    }
    ...
    private void initValueLinkingControl() {
        ...
        setHgap(10);
        setVgap(5);
        getChildren().addAll(fromLabel, valueSelectionHBox, fromRangeLabel, sourceRange, toLabel, destRange);
    }
