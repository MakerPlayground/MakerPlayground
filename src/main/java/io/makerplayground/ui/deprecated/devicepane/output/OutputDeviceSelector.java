...
public class OutputDeviceSelector extends PopOver {
    ...
    public OutputDeviceSelector(SceneViewModel viewModel) {
        FXMLLoader fxmlLoader = new FXMLLoader(getClass().getResource("/fxml/deprecated/devicepane/output/OutputDeviceSelector.fxml"));
        ...
        VirtualProjectDevice.virtualDevicesHaveAction.forEach(device -> {
