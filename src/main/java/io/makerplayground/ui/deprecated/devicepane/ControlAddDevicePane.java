...
public class ControlAddDevicePane extends VBox {
    ...
    public ControlAddDevicePane(GenericDevice genericDevice) {
        ...
        FXMLLoader fxmlLoader = new FXMLLoader(getClass().getResource("/fxml/deprecated/devicepane/ControlAddDevicePane.fxml"));
        ...
        InputStream imageStream = PathUtility.getGenericDeviceIconAsStream(genericDevice);
        if (imageStream == null) {
