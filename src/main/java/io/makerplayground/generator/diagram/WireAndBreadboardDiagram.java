...
////
////                    createLine(projectDevice, sourceMOSI, project.getSelectedController(), desMOSI);
////                    createLine(projectDevice, sourceMISO, project.getSelectedController(), desMISO);
////                    createLine(projectDevice, sourceSCK, project.getSelectedController(), desSCK);
////                    createLine(projectDevice, sourceSS, project.getSelectedController(), desSS);
...
////
////                    createLine(projectDevice, sourceRX, project.getSelectedController(), desRX);
////                    createLine(projectDevice, sourceTX, project.getSelectedController(), desTX);
...
//                    createLine(projectDevice, sourcePort, project.getSelectedController(), destPort);
