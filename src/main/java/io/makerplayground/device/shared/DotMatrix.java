...
@JsonSerialize(using = DotMatrixSerializer.class)
@JsonDeserialize(using = DotMatrixDeserializer.class)
public class DotMatrix {
    ...
    public DotMatrix(int row, int column, String data) {
        this.row = row;
        this.column = column;
    ...
    public void toggle(int row, int column) {
        ...
        this.data[row][column].set(!this.data[row][column].getValue());
    }
