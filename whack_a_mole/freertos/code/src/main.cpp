...
void player1_displayScore()
{
    _display1.showData(player1_score);
}

void player2_displayScore()
{
...
void player1_task(void *pvParameters)
{
    while (1) 
    {
        player1_score = 0;
        ...
        while (millis() - start_time < 60000)
        {
            update();
            player1_popup_mole();
            while (millis() - player1_popup_time < 1000)
            {
...
void player2_task(void *pvParameters)
{
    while (1) 
    {
        player2_score = 0;
        ...
        while (millis() - start_time < 60000)
        {
            update();
            player2_popup_mole();
            while (millis() - player2_popup_time < 1000)
            {
