...
This repository contains supplementary material for the paper titled "ALLI/O IDE: An End-to-End Programming Platform for Embedded Systems". ALLI/O IDE is an end-to-end platform for programming embedded systems using ALLI/O Diagram, an action-based programming language for embedded systems first published in VL/HCC 2024 ([link](https://ieeexplore.ieee.org/document/10714558)).
...
- [Automatic Night Light v2](night_light_v2/README.md)
- [Windshield Wiper](windshield_wipers/README.md)
- [Scoreboard](score_board/README.md)
- [Whack-A-Mole Game](whack_a_mole/README.md)
